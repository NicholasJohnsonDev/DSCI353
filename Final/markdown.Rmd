...
The code below was done this way to maintain each observation in he case of a tie instead of dropping one. Note that there are 52 observations because there are two ties, in South Dakota and Montana.
```{r, warning = FALSE, message = FALSE, echo = TRUE}
# Table of adoptable dogs per state
