...
### How many adoptable dogs are there in each state?
This information can be found using the dog_adoptable data set,
...
### What is the most common breed up for adoption in each state?
The code below was done this way to maintain each observation in he case of a tie instead of dropping one. Note that there are 53 observations because there are two ties and DC is counted as a state.
```{r, warning = FALSE, message = FALSE, echo = TRUE}
# Table of adoptable dogs per state
# State and 
